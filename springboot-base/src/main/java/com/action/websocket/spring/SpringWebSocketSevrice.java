...
public class SpringWebSocketSevrice {
    ...
    private static CopyOnWriteArraySet<SpringWebSocketSevrice> webSocketSet = new CopyOnWriteArraySet<SpringWebSocketSevrice>();
    ...
    public void onMessage(String message, Session session) {
        ...
        //群发消息
        for (SpringWebSocketSevrice item : webSocketSet) {
            try {
    ...
    public static synchronized void addOnlineCount() {
        SpringWebSocketSevrice.onlineCount++;
    }
